...
#' @name wimids
#'
#' @description The \code{wimids} object contains data of weighted multiply imputed datasets. The \code{wimids} object is generated by the \code{weightitmice()} function.
#'
#' @details The \code{wimids} objects has methods for the \code{print()}, \code{summary()}, and \code{plot()} functions.
#'
