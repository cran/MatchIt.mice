...
#'   \item{KNEEOA}{Diagnosis of knee osteoarthritis, coded as \code{0} (not affected) and \code{1} (affected)}
#'   \item{HANDOA}{Diagnosis of hand osteoarthritis, coded as \code{0} (not affected) and \code{1} (affected)}
#'   ...
#'
#' }
#' @source The information presented in the \code{handoa} dataset is based on the publicly available data of the Osteoarthritis Initiative (OAI) project \url{https://nda.nih.gov/oai/}, with changes.
